...
function OnlineHubs(props){
    ...
    <div class = "row ">
       ...
       <p class = "tools"><i class="fas fa-walking"></i> Access to the Walk-in help centers called HUBS run by successful FIRST teams to request team support such as machine shop use, resources, robot build and award support. </p>
