...
function OnlineHubs(props){
    ...
    <div class = "row ">
       ...
       <div className = "col-sm-12 realhubtext" id='title'>
         <p className = "tools hubdesc"><em className = "FIRST">FIRST </em> Robotics Canada provides all FIRST teams with tools for support at any given time including providing support to <em className = "FIRST">FIRST </em>Robotics Competition rookie teams. Think of the Walk-in Help Centre as a HUB location where teams can plan ahead or The Online Helpdesk and Hubs are run by <em className = "FIRST">FIRST </em>Robotics Competition veteran teams where you can drop in and request team support including machine shop resources, build, design, programming and business and awards support. </p>
