...
function Commitment (props){
    ...
    <div className = "flex-container">
             ...
             FIRST understands the broader societal context of economic, educational, and social factors historically leading to disproportionate access and outcomes. Leveraging cross-sector and industry collaborations, FIRST is actively engaged in developing and delivering strategies that remove barriers and ensure greater access to FIRST programs so that all youth can participate. Students and volunteers engaged in FIRST Canada programs will reflect inclusive diversity of contemporary Canadian society. Respect and equity are key to this experience. We encourage greater access and participation in our programs for women, First Nations, and the underserved.
             </p>
